...
insert into USERS ( USER_PROFILE_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, USER_NAME, LOGIN_NAME, LOGIN_PASSWORD ) select '1', 1, 1 , 'admin', 'admin', '1234';

insert into USERS ( USER_PROFILE_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, USER_NAME, LOGIN_NAME, LOGIN_PASSWORD ) select '2', 1, 1 , 'Sony', 'comp1' , '1234';
insert into USERS ( USER_PROFILE_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, USER_NAME, LOGIN_NAME, LOGIN_PASSWORD ) select '2', 1, 1 , 'Gelp', 'comp2' , '1234';

insert into USERS ( USER_PROFILE_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, USER_NAME, LOGIN_NAME, LOGIN_PASSWORD ) select '3', 1, 1 , 'Raviv Shweid', 'cust1' , '1234';
insert into USERS ( USER_PROFILE_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, USER_NAME, LOGIN_NAME, LOGIN_PASSWORD ) select '3', 1, 1 , 'Avi Edri', 'cust2' , '1234';
...
insert into COMPANYS ( USER_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, COMPANY_NAME, COMPANY_EMAIL ) select 2, 1, 1, 'Sony' , 'sony@gmail.com';
insert into COMPANYS ( USER_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, COMPANY_NAME, COMPANY_EMAIL ) select 3, 1, 1, 'Gelp' , 'gelp@gmail.com';
...
insert into CUSTOMERS ( USER_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, CUSTOMER_NAME  ) select 4, 1, 1, 'Raviv Shweid'  ;
insert into CUSTOMERS ( USER_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, CUSTOMER_NAME  ) select 5, 1, 1, 'Avi Edri'  ;
go
