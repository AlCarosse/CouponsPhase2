...
insert into USERS ( USER_PROFILE_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, USER_NAME, LOGIN_NAME, LOGIN_PASSWORD ) select '2', 1, 1 , 'Company 1', 'comp1' , '1234';
insert into USERS ( USER_PROFILE_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, USER_NAME, LOGIN_NAME, LOGIN_PASSWORD ) select '2', 1, 1 , 'Company 2', 'comp2' , '1234';

insert into USERS ( USER_PROFILE_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, USER_NAME, LOGIN_NAME, LOGIN_PASSWORD ) select '3', 1, 1 , 'Customer 1', 'cust1' , '1234';
insert into USERS ( USER_PROFILE_ID, CREATED_BY_USER_ID, UPDATED_BY_USER_ID, USER_NAME, LOGIN_NAME, LOGIN_PASSWORD ) select '3', 1, 1 , 'Customer 2', 'cust2' , '1234';
